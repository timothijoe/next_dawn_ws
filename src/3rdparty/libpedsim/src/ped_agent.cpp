...
Ped::Tvector Ped::Tagent::obstacleForce() const {
  ...
  double distance = sqrt(minDistanceSquared);
...
void Ped::Tagent::computeForces() {
  ...
  if(id % 5 == 0){
    std::cout << "id: " << id << "position: " << p.x << p.y << std::endl;
  }
...
//  std::cout << "Desired force: ("<<desiredforce.x<<" , "<<desiredforce.y<<");"<< std::endl;
//  std::cout << "Social force: ("<<socialforce.x<<" , "<<socialforce.y<<");"<<std::endl;
//  std::cout << "Obstacle force: ("<<obstacleforce.x<<" , "<<obstacleforce.y<<");"<<std::endl;
//  std::cout << "My force: ("<<myforce.x<<" , "<<myforce.y<<");"<<std::endl;
//  std::cout << "current position: ("<< p.x<<" , "<<p.y << ");" << std::endl;
//  std::cout << "current velocity: ("<< v.x<<" , "<<v.y << ");" << std::endl;
//  a.x = round(a.x * 10)/10;
//  a.x = round(a.x * 10)/10;
