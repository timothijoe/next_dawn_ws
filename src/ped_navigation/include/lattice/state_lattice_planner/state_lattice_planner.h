...
#include <diff_drive_generator/motion_model_diff_drive.h>
#include <diff_drive_generator/trajectory_generator_diff_drive.h>
#include "lattice_lookup_table/lookup_table_utils.h"
...
public:
    ...
    void generate_biased_point_states(const int, const Eigen::Vector3d&, double, std::vector<Eigen::Vector3d>&);
    /**
