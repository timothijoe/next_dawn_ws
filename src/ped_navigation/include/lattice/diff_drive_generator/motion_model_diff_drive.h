...
public:
    ...
    public:
         ...
         * @parchagnhengeam[in] _vf Terminal velocity [m/s]
     ...
     */
    void generate_energy(const double, const double, const VelocityParams&, const double, const double, const double, Eigen::Vector3d&,double& energy);
    bool get_hamiltonian_from_param(const double dt, const double trajectory_length, const VelocityParams& _vel, const double k0,
