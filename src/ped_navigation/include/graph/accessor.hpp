 ...
 *        the value and index represent the opposite half edge
 *
 ...
 *
**/
void retrieveNeighbors(const Delaunator* graph,
 ...
 * the output in this case the traingle vertex index of the nearest vertex
 *
**/
bool locateCurrentFace(const Delaunator* graph, const double px, const double py,
                       index* output, double* distance, double SAFE_DIST=0.0, size_t PED_START=6)
{
